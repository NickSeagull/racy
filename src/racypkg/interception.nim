#====================================================================
#
#               Wrapper around Interception driver
#
#====================================================================
...
const
  ...
  INTERCEPTION_KEY_DOWN* = 0x00000000
  INTERCEPTION_KEY_UP* = 0x00000001
  INTERCEPTION_KEY_E0* = 0x00000002
  INTERCEPTION_KEY_E1* = 0x00000004
  ...
  INTERCEPTION_FILTER_KEY_UP* = INTERCEPTION_KEY_UP.int shl 1
  INTERCEPTION_FILTER_KEY_E0* = INTERCEPTION_KEY_E0.int shl 1
  INTERCEPTION_FILTER_KEY_E1* = INTERCEPTION_KEY_E1.int shl 1
  INTERCEPTION_FILTER_KEY_TERMSRV_SET_LED* = INTERCEPTION_KEY_TERMSRV_SET_LED.int shl 1
  INTERCEPTION_FILTER_KEY_TERMSRV_SHADOW* = INTERCEPTION_KEY_TERMSRV_SHADOW.int shl 1
  INTERCEPTION_FILTER_KEY_TERMSRV_VKPACKET* = INTERCEPTION_KEY_TERMSRV_VKPACKET.int shl 1
  ...
  INTERCEPTION_MOUSE_WHEEL* = 0x00000400
  INTERCEPTION_MOUSE_HWHEEL* = 0x00000800
  ...
  INTERCEPTION_FILTER_MOUSE_ALL* = 0x0000FFFF
...
proc interception_create_context*(): InterceptionContext{.importc.}
proc interception_destroy_context*(context: InterceptionContext){.importc.}
proc interception_get_precedence*(context: InterceptionContext;
                                 device: InterceptionDevice): InterceptionPrecedence{.importc.}
proc interception_set_precedence*(context: InterceptionContext;
                                 device: InterceptionDevice;
                                 precedence: InterceptionPrecedence){.importc.}
proc interception_get_filter*(context: InterceptionContext;
                             device: InterceptionDevice): InterceptionFilter{.importc.}
proc interception_set_filter*(context: InterceptionContext;
                             predicate: InterceptionPredicate;
                             filter: InterceptionFilter){.importc.}
proc interception_wait*(context: InterceptionContext): InterceptionDevice{.importc.}
proc interception_wait_with_timeout*(context: InterceptionContext, milliseconds: culong): InterceptionDevice {.importc.}
proc interception_send*(context: InterceptionContext; device: InterceptionDevice;
                       stroke: ptr InterceptionStroke; nstroke: cuint): cint{.importc.}
proc interception_receive*(context: InterceptionContext;
                          device: InterceptionDevice;
                          stroke: ptr InterceptionStroke; nstroke: cuint): cint {.importc.}
proc interception_get_hardware_id*(context: InterceptionContext;
                                  device: InterceptionDevice;
                                  hardware_id_buffer: pointer; buffer_size: cuint): cuint{.importc.}
proc interception_is_invalid*(device: InterceptionDevice): cint{.importc.}
proc interception_is_keyboard*(device: InterceptionDevice): cint{.importc.}
proc interception_is_mouse*(device: InterceptionDevice): cint {.importc.}